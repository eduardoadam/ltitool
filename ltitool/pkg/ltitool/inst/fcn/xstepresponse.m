...
function  xstepresponse(t,resp_escalon,AmplitudSP,Tstop,yinf,gamma_tol,delay,sigma_domin,Test,cont_Test,string_title);


% Eduardo Adam
% FIQ-UNL, Santiago del Estero 2654, S3000AOM, Santa Fe, Argentina
%  e-mail:   eadam@fiq.unl.edu.ar
%  web-page: www.fiq.unl.edu.ar/control
%
...
%tit=title('Respuesta al Escalon del Sistema Realimentado');
tit=title(string_title);
set(tit,'fontsize',14);  
grid;
legend(graf,'Step Resp.','Setpoint');
...
% Grafico las tolerancias de error de estado estacionario
if (sigma_domin < 0)
	p2=plot(t,yinf_vec,'--','linewidth',1.1, 'color', [255/255 0 0], ...
