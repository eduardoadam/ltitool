...
function ret = show_mainWnd()
  ...
  _xPos = (_scrSize(3) - 690)/2;
  _yPos = (_scrSize(4) - 681)/2;
   mainWnd = figure ( ... 
	'Color', [0.937 0.922 0.906], ...
	'Position', [_xPos _yPos 690 681], ...
	'Resize', 'on', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
  Image_ppl = axes( ...
