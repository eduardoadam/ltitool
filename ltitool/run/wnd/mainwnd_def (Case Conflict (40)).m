...
function ret = show_mainWnd()
  ...
  _xPos = (_scrSize(3) - 1018)/2;
  _yPos = (_scrSize(4) - 645)/2;
   mainWnd = figure ( ... 
	'Color', [0.937 0.922 0.906], ...
	'Position', [_xPos _yPos 1018 645], ...
	'Resize', 'on', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
  Image_ppl = axes( ...
