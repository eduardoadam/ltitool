...
function ret = show_mainWnd()
  ...
  _xPos = (_scrSize(3) - 1062)/2;
  _yPos = (_scrSize(4) - 645)/2;
   mainWnd = figure ( ... 
	'Color', [0.937 0.922 0.906], ...
	'Position', [_xPos _yPos 1062 645], ...
	'Resize', 'on', ...
	'windowstyle', 'normal', ...
	'MenuBar', 'none');
  Image_ppl = axes( ...
...
if (comparisonVersion==0)
    disp('LTITOOL Actual Version:',ltitoolActualVersion)
    disp('LTITOOL New Version:',ltitoolNewVersion)
    disp('New version is available. Download from here:')
endif
